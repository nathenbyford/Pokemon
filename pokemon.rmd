...
In a dataset rife with unexplainible associations, our group did find one variable that influences numerous other variables. That variable is the female rate. Female rate influenced both the capture rate, and the happiness. Though not included in this analysis, during our exploratory portion of our analysis, we found other variables that were influenced by female rate, especially the primary color. 
